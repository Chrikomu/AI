...
<user-story-example>
1. As a driver developer, I want bad-checksum frames rejected, so that corrupt data never reaches the user app
</user-story-example>
